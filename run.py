...
def parse():
    ...
    aug.add_argument('-aa', '--auto_augment', type=str, default='rand-n2-m10-mstd0.5-inc1', metavar='NAME',
                     help='Use AutoAugment policy. "v0" or "original". " + " (default: rand-n2-m10-mstd0.5-inc1)'),
